...
//     ref.listen<AuthState>(authViewModelProvider, (previous, next) {
//       if (next.isSignUpSuccess && !next.isLoading && next.error == null) {
...
// File: lib/features/auth/presentation/views/signup_view.dart (Correct Implementation)
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:make_your_meal/features/auth/presentation/providers/auth_provider.dart';
import 'package:make_your_meal/features/auth/presentation/views/login_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<AuthState>(authViewModelProvider, (previous, next) {
      if (next.isSignUpSuccess && !next.isLoading && next.error == null) {
        ...
        ref.read(authViewModelProvider.notifier).clearSignUpSuccess();
        ...
        // Navigate to login page with complete route replacement
        Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (context) => const LoginView()),
          (route) => false,
